...
provider_call_timeout_secs = 120  # Max seconds for a single provider call (0 = no timeout)
...
# Optional: protected-site backend switching (Kasada/Imperva/empty shells).
# [tools.browser.protection]
